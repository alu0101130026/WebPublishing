...
function welcome(user){
    ...
    document.getElementById('bienvenido').innerHTML ="<h6> Bienvenido de nuevo </h6>";
}

function description(){
  alert('Julieta deja una carta a romeo: Se escucha la carta con la voz de Julieta: Querido Romeo cuando leas esto, ya me habré ido, llevamos siglos ligados el uno al otro, y no se, las cosas hoy en día no son como antes, ya nada es para siempre Romeo, y yo ahora no quiero compromisos, además lo nuestro siempre ha sido una tragedia. Se ve a Julieta caminando hacia el coche y salta un cartel que dice: Comparte vehículo en la parte superior y en la parte inferior pone” Y ahora con nuestro servicio, jamás volverás a tener excusa”')
}